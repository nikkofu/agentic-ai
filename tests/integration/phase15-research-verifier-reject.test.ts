...
describe("phase15 research verifier reject", () => {
  it("rejects research delivery when references artifact is missing", async () => {
      ...
      orchestrator: {
        runSingleNodeContext: vi.fn().mockResolvedValue({
          ...
          delivery: {
            ...
            artifacts: [],
            verification: [{ kind: "source", summary: "README", sourceId: "a", passed: true }],
            risks: [],
            next_actions: []
          }
        }),
